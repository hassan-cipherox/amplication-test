...
@InputType()
class AttributeUpdateManyWithoutAttributeGroupsInput {
...
export { AttributeUpdateManyWithoutAttributeGroupsInput as AttributeUpdateManyWithoutAttributeGroupsInput };
