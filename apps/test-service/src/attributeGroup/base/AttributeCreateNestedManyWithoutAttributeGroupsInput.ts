...
@InputType()
class AttributeCreateNestedManyWithoutAttributeGroupsInput {
...
export { AttributeCreateNestedManyWithoutAttributeGroupsInput as AttributeCreateNestedManyWithoutAttributeGroupsInput };
